...
const char * LIB_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\debug\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\debug\\lib;D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\debug\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /D/source/ConsoleApplication1/vcpkg_installed/vcpkg/pkgs/li", f);
  fputs ("biconv_x64-windows/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/deb", f);
  fputs ("ug/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"iconv.exe:iconv:$LINENO: libtool wrapper (GNU libtool) 2.4.7\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/D/source/ConsoleApplication1/vcpkg_installed/vcpkg/pkgs/libiconv_x64-", f);
  fputs ("windows/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/debug/lib:/D/s", f);
  fputs ("ource/ConsoleApplication1/vcpkg_installed/vcpkg/pkgs/libiconv_x64-windows/D/sou", f);
  fputs ("rce/ConsoleApplication1/vcpkg_installed/x64-windows/debug/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/D/source/ConsoleApplication1/vcpkg_installed/vcpkg/pkgs/libiconv_x64", f);
  fputs ("-windows/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/debug/lib:$PA", f);
  fputs ("TH\"\n", f);
  fputs ("\n", f);
