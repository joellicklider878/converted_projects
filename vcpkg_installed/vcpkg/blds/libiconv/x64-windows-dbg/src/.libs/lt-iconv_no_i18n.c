...
const char * LIB_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\blds\\libiconv\\x64-windows-dbg\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\blds\\libiconv\\x64-windows-dbg\\lib\\.libs;D:\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\debug\\lib;D:\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\debug\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"iconv_no_i18n.exe:iconv_no_i18n:$LINENO: newargv[0]: $progdir/$p", f);
  fputs ("rogram\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/source/ConsoleApplication1/vcpkg_installed/vcpkg/blds/libiconv/x64-", f);
  fputs ("windows-dbg/lib/.libs:/D/source/ConsoleApplication1/vcpkg_installed/x64-windows", f);
  fputs ("/debug/lib:/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/debug/bin:", f);
  fputs ("$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/source/ConsoleApplication1/vcpkg_installed/vcpkg/blds/libiconv/x64", f);
  fputs ("-windows-dbg/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
