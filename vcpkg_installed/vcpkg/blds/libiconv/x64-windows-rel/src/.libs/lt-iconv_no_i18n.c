...
const char * LIB_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\blds\\libiconv\\x64-windows-rel\\lib\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\blds\\libiconv\\x64-windows-rel\\lib\\.libs;D:\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\lib;D:\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("windows-rel/lib/.libs:/D/source/ConsoleApplication1/vcpkg_installed/x64-windows", f);
  fputs ("/lib:/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/source/ConsoleApplication1/vcpkg_installed/vcpkg/blds/libiconv/x64", f);
  fputs ("-windows-rel/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
