...
const char * LIB_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\lib;D:\\source\\ConsoleApplication1\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\source\\ConsoleApplication1\\vcpkg_installed\\x64-windows\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("biconv_x64-windows/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/lib", f);
  fputs ("/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("windows/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/lib:/D/source/", f);
  fputs ("ConsoleApplication1/vcpkg_installed/vcpkg/pkgs/libiconv_x64-windows/D/source/Co", f);
  fputs ("nsoleApplication1/vcpkg_installed/x64-windows/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/D/source/ConsoleApplication1/vcpkg_installed/vcpkg/pkgs/libiconv_x64", f);
  fputs ("-windows/D/source/ConsoleApplication1/vcpkg_installed/x64-windows/lib:$PATH\"\n", f);
  fputs ("\n", f);
